...
function create() {
  ...
  platforms.create(200, 200, "platform").setScale(0.15, 0.1).refreshBody();
  platforms.create(100, 400, "platform").setScale(0.5, 0.1).refreshBody();
  platforms.create(300, 300, "platform").setScale(0.5, 0.1).refreshBody();
  platforms.create(500, 200, "platform").setScale(0.25, 0.1).refreshBody();
  platforms.create(800, 300, "platform").setScale(0.5, 0.1).refreshBody();
  ...
  gameState.starOne = this.physics.add.sprite(100, 50, "star").setScale(0.05);
  this.physics.add.collider(gameState.starOne, gameState.player);
  this.physics.add.collider(gameState.starOne, platforms);

  gameState.starTwo = this.physics.add.sprite(800, 50, "star").setScale(0.05);

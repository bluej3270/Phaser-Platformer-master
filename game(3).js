...
function create() {
  ...
  platforms.create(200, 200, "platform").setScale(0.15, 0.1).refreshBody();

  platforms.create(225, 500, "platform").setScale(3, 0.3).refreshBody();
  platforms.create(200, 200, "platform").setScale(0.15, 0.1).refreshBody();

  platforms.create(600, 400, "platform").setScale(0.35, 0.1).refreshBody();
  platforms.create(600, 300, "platform").setScale(0.35, 0.1).refreshBody();
  platforms.create(600, 200, "platform").setScale(0.35, 0.1).refreshBody();
  platforms.create(600, 100, "platform").setScale(0.35, 0.1).refreshBody();
  platforms.create(800, 300, "platform").setScale(0.15, 0.1).refreshBody();
  platforms.create(100, 100, "platform").setScale(0.15, 0.1).refreshBody();
  platforms.create(400, 100, "platform").setScale(0.35, 0.1).refreshBody();

  platforms.create(880, 500, "platform").setScale(0.05, 0.5).refreshBody();
  platforms.create(20, 500, "platform").setScale(0.05, 0.5).refreshBody();
  ...
  gameState.starOne = this.physics.add.sprite(100, 50, "star").setScale(0.15);
  this.physics.add.collider(gameState.starOne, gameState.player);
  this.physics.add.collider(gameState.starOne, platforms);

  gameState.starTwo = this.physics.add.sprite(800, 50, "star").setScale(0.15);

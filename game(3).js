...
function create() {
  ...
  platforms.create(225, 500, 'platform').setScale(3, .3).refreshBody();	platforms.create(200, 200, 'platform').setScale(.15, .1).refreshBody();
	...
	platforms.create(600, 400, 'platform').setScale(.35, .1).refreshBody();
	platforms.create(600, 300, 'platform').setScale(.35, .1).refreshBody();
	platforms.create(600, 200, 'platform').setScale(.35, .1).refreshBody();
	platforms.create(600, 100, 'platform').setScale(.35, .1).refreshBody();
	platforms.create(800, 300, 'platform').setScale(.15, .1).refreshBody();
	platforms.create(100, 100, 'platform').setScale(.15, .1).refreshBody();
	platforms.create(400, 100, 'platform').setScale(.35, .1).refreshBody();

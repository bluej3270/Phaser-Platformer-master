...
function create() {
  ...
  platforms.create(300, 300, "platform").setScale(0.15, 0.1).refreshBody();
  platforms.create(500, 400, "platform").setScale(0.15, 0.1).refreshBody();
  ...
  gameState.baddie2 = this.physics.add.sprite(200, 50, "bug1");

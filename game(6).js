...
function create() {
  ...
  platforms.create(350, 300, "platform").setScale(2, 0.1).refreshBody();
  platforms.create(550, 200, "platform").setScale(2, 0.1).refreshBody();
  platforms.create(350, 100, "platform").setScale(2, 0.1).refreshBody();

  gameState.baddie = this.physics.add.sprite(100, 50, "bug1");
  this.physics.add.collider(gameState.baddie, platforms);
  this.physics.add.collider(gameState.baddie, gameState.starOne);
  this.physics.add.collider(gameState.baddie, gameState.starTwo);
  ...
  gameState.starOne = this.physics.add.sprite(300, 50, "star").setScale(0.15);
